...
public class PatientAPI extends HttpServlet {
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response)
		...
		String output = patientServiceImpl.updatePatientDetails(paras.get("hidPatientIdSave").toString(),
				paras.get("fName").toString(), paras.get("lName").toString(), paras.get("gender").toString(),
				paras.get("NIC").toString(), paras.get("DOB").toString(), paras.get("bloodGroup").toString(),
				paras.get("email").toString().replace("%40", "@"), paras.get("phone").toString(),
